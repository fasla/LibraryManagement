 ...
 * @author fasla faseel
 */
@WebServlet(name = "PopSubDropdown", urlPatterns = {"/PopSubDropdown"})
public class PopSubDropdown extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PopSubDropdown</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PopSubDropdown at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String subId = request.getParameter("subClassification");
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("AddBookControl");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String categoryId2 = request.getParameter("subClassification");
 
        request.setAttribute("selectedCatId2", categoryId2);
    }
