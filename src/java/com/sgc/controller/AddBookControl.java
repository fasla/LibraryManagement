 ...
 * @author fasla faseel
 */
@WebServlet(name = "AddBookControl", urlPatterns = {"/AddBookControl"})
public class AddBookControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddBookControl</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddBookControl at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    private void listCategory(HttpServletRequest request, HttpServletResponse response)
        ...
        BookModel book=new BookModel();
         ...
         if (request.getAttribute("subId")!= null){
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("selectedCatId2", categoryId);
