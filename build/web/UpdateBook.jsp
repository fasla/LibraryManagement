...
.footer {
    ...
    <body>
        ...
        <div>
            <center><h1 id ="welcomeHeading">UPDATE BOOK DETAILS</h1></center>
        </div>
            
    <div class="container" >
        <form action="UpdateBookForAction" method="get">
        ...
        <td style="width:200px;"><label for="Subclassification"><b>Sub  classification</b></label></td>
            <td> <select style="width:300px;" name="subClassification">
                        ...
                        <c:forEach items="${listSubCategory}" var="category2">
                                <option value="${category2.subId}"
                                <c:if test="${category2.mainId eq selectedCatId2}">selected="selected"</c:if>>
        ...
        <input type="text" placeholder="Enter Year of publishing" name="yop" value="${yop}" required>
        
        <label for="Last printed year"><b>Last printed year</b></label>
        <input type="text" placeholder="Enter Last Printed Year" name="lpy" value="${lpy}" required>
        
        <label for="ISBN no"><b>ISBN no</b></label>
        <input type="text" placeholder="Enter ISBN no" name="isbn" value="${isbn}" required>
        
        <label for="No of pages"><b>No of pages</b></label>
        <input type="text" placeholder="Enter No of pages" name="noP" value="${noP}" required>
        <button class="btn btn-primary" type="submit" name="AddBookButton">update</button>
        </form>
    ...
    <script>
            function selectvalue(form) {
                form.action = "PopSubDropdownForUpdatePage";
                form.submit();                
            }
        </script>
</html>
