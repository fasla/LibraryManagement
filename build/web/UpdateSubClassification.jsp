...
.footer {
    ...
    <body>
        ...
        <div>
            <center><h1 id ="welcomeHeading">UPDATE SUB CLASSIFICATION DETAILS</h1></center>
        </div>
            
    <div class="container" >
        <form action="UpdateSubClassifyForAction" method="get">
        <label for="Book Id"><b>Sub Book Id</b></label>
        <input type="text" placeholder="Enter Sub Classification id" name="subId" value="${bookId}" required>
        ...
        <table class="classify" cellpadding="10">
            <tr> <td style="width:150px;"><label for="Main classification"><b>Main classification</b></label></td>
                ...
                <td> <select style="width:300px;" name="mainClassification" >
        ...
        <label for="Book Id"><b>Sub Classification Name</b></label>
         ...
         <input type="text" placeholder="Enter Sub Classification Name" name="subName" value="${subName}" required>
