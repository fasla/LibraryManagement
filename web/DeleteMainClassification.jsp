...
.footer {
    ...
    <body>
        ...
        <div>
            <center><h1 id ="welcomeHeading">DELETE SUB CLASSIFICATION DETAILS</h1></center>
        </div>
            
    <div class="container" >
        <form action="DeleteMainClassControl" method ="get" >
        <label for="Book Id"><b>Main Classification Id</b></label>
        <input type="text" placeholder="Enter Sub Classification Id" name="mainId" required>
