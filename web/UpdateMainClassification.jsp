...
.footer {
    ...
    <body>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="menu-item dropdown dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="menu-item ">
                                    <a href="SearchMainClassification.jsp">Search Sub Classification</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div>
            <center><h1 id ="welcomeHeading">UPDATE MAIN CLASSIFICATION DETAILS</h1></center>
        </div>
            
    <div class="container" >
        <form action="UpdateMainClassifyForAction" method="get">
        <label for="Book Id"><b>Main Classification Id</b></label>
        <input type="text" placeholder="Enter Main Classification id" name="mainId" value="${bookId}" required>
        ...
        <br><br>
        <br>
        <label for="Book Id"><b>Sub Classification Name</b></label>
        
         <input type="text" placeholder="Enter Main Classification Name" name="mainName" value="${subName}" required>
