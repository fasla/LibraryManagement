...
.footer {
    ...
    <body>
        ...
        <div>
            <center><h1 id ="welcomeHeading">ADD MAIN CLASSIFICATION DETAILS</h1></center>
        </div>
            
    <div class="container" >
        <form action="AddMainClassControl" method="get">
        <label for="Book Id"><b>Main Classification Id</b></label>
        <input type="text" placeholder="Enter Main classification id" name="mId" required>

        <label for="Title"><b>Main Classification Name</b></label>
        <input type="text" placeholder="Enter Main Classification Name" name="mName"required >
