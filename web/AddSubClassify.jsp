...
.footer {
    ...
    <body>
        ...
        <div>
            <center><h1 id ="welcomeHeading">ADD SUB CLASSIFICATION DETAILS</h1></center>
        </div>
            
    <div class="container" >
        <form action="AddSubClassController" method="get">
        <label for="Book Id"><b>Sub Classification Id</b></label>
        <input type="text" placeholder="Enter Sub classification id" name="subId"required >

        <label for="Title"><b>Sub Classification Name</b></label>
        <input type="text" placeholder="Enter Sub Classification Name" name="subName" required>
        
        <label for="Title"><b>Main Classification Id</b></label>
        <input type="text" placeholder="Enter Main Classification Id" name="mainId" required>
        
        <button class="btn btn-primary" type="submit" name="subButton" >Add</button>
        </form>
    </div>
